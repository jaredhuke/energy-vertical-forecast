...
export function RosterView() {
  return (
    <div className="grid" style={{ gap: 16 }}>
      <div className="hint">
        Name your Energy Vertical people so the dashboard can flag over-allocation. Delivery lines can be named here too,
        or left abstract (added as role lines directly on an opportunity). Capacity is weekly FTE — 1.0 is full time.
      </div>
